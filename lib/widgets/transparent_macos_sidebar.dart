...
///
/// By default, a [TransparentMacOSSidebar] updates its visual effect view whenever its
...
class TransparentMacOSSidebar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return VisualEffectSubviewContainer(
      ...
      // TransparentMacOSSidebar widget adds a large negative top margin to the visual
      // effect subview.
